...
- Which departments/regions were overspending
- What expense categories were driving variances
- How performance evolved month-over-month and YTD

## Solution
An interactive Excel dashboard built with **Power Query + Power Pivot** that enables:
...
- Filtering by region, department, and period

## Key Features
- Star-schema data model in Power Pivot
- Power Query transformations for clean, repeatable refresh steps
- Custom DAX measures for variance and cumulative analysis
- Executive-focused layout and clear KPI storytelling

## Tools & Skills Demonstrated
- Microsoft Excel (Power Query, Power Pivot)
- DAX (variance, % variance, cumulative/YTD logic)
- Data modeling (star schema)
- Financial performance analysis & executive reporting

## Repository Contents
- `dashboard/` — Final Excel dashboard file  
- `screenshots/` — Dashboard and model screenshots for quick review  
- `documentation/` — Executive summary and methodology (PDF)  
- `data/` — Source data used in the model + notes

## How to Review (Recommended)
1. Start with `/screenshots/` for a fast overview  
2. Download the Excel file from `/dashboard/`  
3. Read the executive summary in `/documentation/`
